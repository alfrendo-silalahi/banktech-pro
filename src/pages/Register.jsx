...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!passwordRegex.test(password)) {
            alert("Password harus 8 karakter, huruf besar, kecil, angka, dan simbol");
            setLoading(false);
            return;
        }
        ...
        <div className="flex min-h-screen">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-8">
                <div className="max-w-md w-full">
                    ...
                    <p className="text-gray-500 mb-6">Complete the form to sign up and get started!</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="w-1/2">
                                <label className="block mb-1 font-medium">Last Name*</label> {/* belum validasi last name*/}
                                <input
                                    type="text"
                                    value={lastName}
